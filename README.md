...
<img width="640" height="427" alt="image" src="https://github.com/user-attachments/assets/44586909-ac5a-4115-91fe-6e0d11353304" />\
...
```
Result
|Total number of products|Number of distinct product|
|------------------------|--------------------------|
|1037|661|
### 1. Which products contribute the most to carbon emissions?
Query
```sql
SELECT pe.product_name, ROUND(avg(pe.carbon_footprint_pcf ),2) AS Average_carbon_footprint 
FROM product_emissions pe 
GROUP BY pe.product_name 
ORDER BY Average_carbon_footprint DESC
LIMIT 10;
```
Result: <b>TOP 10 products with highest contribution to Carbon Emisison</b>
...
LIMIT 10;
```
Result: <b>TOP 10 Products across Carbon-Intensive Industry Groups</b>
...
LIMIT 10;
```
Result: <b>TOP 10 industries that contribute the most to carbon emissions</b>
...
LIMIT 10;
```
Result: <b>Top 10 companies with the highest carbon emissions</b>
...
LIMIT 10;
```
Result: <b>Top 10 countries with the highest carbon emissions</b>
...
```
Result:
|year|Sum_carbon_footprint|Average_carbon_footprint|
|----|--------------------|------------------------|
